  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-3xl mx-auto px-8 py-12">
        ...
        <p className="text-zinc-400 text-sm mb-10">Technical documentation for Earprint.</p>
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <p className="font-medium text-zinc-100 group-hover:text-white">How Earprint uses Spotify</p>
